...
- the executable two-unit baseline remains `14.359960 MW @ 23 kn`
...
| Parameter | Value |
|-----------|-------|
| Power @ 23 kn | 14.359960 MW |
| Hydrodynamic anchor | 14.350634 MW |
| Loaded displacement | 10,955.255 t |
| One-unit-out support | 19.595771 kn |

## Open Closure Gaps

- authority topology and package verdicts
- reserve doctrine, service-load, electrical single-line, and delivered-power mapping closure
- motion, seakeeping, and class-facing closure
- Phase 14 terminal handoff
