...
<sub>02 · Hull 20098 animated mechanics diagram · b-cell b-codec-mechanics cell-5 row-2</sub>
<figure>
        <div><img src="docs/assets/product-page-mechanics.gif" alt="Hull-20098 approved scientific square mechanics diagram showing hydrogen-electric power-envelope mechanics."></div>
...
<div><b>02 · MARKETS</b><span>ADJACENT FORECASTS</span></div>
      <div>
        <div>
          <div><span>Shipbuilding 2030</span><span></span><span>$195.2B</span></div>
          <div><span>Green shipping tech 2031</span><span></span><span>$79.4B</span></div>
          <div><span>Vessel retrofits 2030</span><span></span><span>$27.4B</span></div>
          <div><span>Hydrogen maritime fuel 2030</span><span></span><span>$11.6B</span></div>
          <div><span>Marine engineering software 2030</span><span></span><span>$9.8B</span></div>
        </div>
      </div>
...
<div><b>05.3 · BENCHMARKS</b><span>CHECKED PACKET 2026-05-03</span></div>
      <div>
        ...
        <div>
          ...
          <div><span>V_02</span><span></span><span>PASS</span></div>
          <div><span>V_03 / V_04</span><span></span><span>PASS</span></div>
        </div>
      </div>
...
<div><b>06.1 · BOUNDED VALIDATION &middot; HULL 20098 PUBLIC SURFACE</b></div>
      <div>
        <div>
          <div><span>V_01 hydro power</span><span></span><span>PASS</span></div>
          <div><span>V_02 displacement</span><span></span><span>PASS</span></div>
          <div><span>V_03 propulsion</span><span></span><span>PASS</span></div>
          <div><span>V_04 surface</span><span></span><span>PASS</span></div>
        </div>
      </div>
</td>
</tr>
